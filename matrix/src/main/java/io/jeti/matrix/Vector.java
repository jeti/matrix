...
public class Vector implements Vec<Vector>, Gettable1<Double> {
     ...
     */
    public static Vector ones(int elems) {
        return new Vector(elems, index -> 1d);
    }
     ...
     */
    public static Vector zeros(int elems) {
        return new Vector(elems, index -> 0d);
    }
     ...
     */
    public static Vector rand(int elems) {
        return new Vector(elems, index -> random.nextDouble());
    }
     ...
     */
    public static Vector randn(int elems) {
        return new Vector(elems, index -> random.nextGaussian());
    }
